...
def get_directory_name():
    _EXP_NAME = 'Workload_{}_Algo_{}_rlform_{}_num_steps_{}_seed_{}_lr_{}_entropy_{}_rewardscale_{}'.format(_DRAM_TRACE.value, _RL_AGO.value, _RL_FORM.value,_NUM_STEPS.value, _SEED.value, _LEARNING_RATE.value, _ENTROPY_COST.value, _REWARD_SCALE.value)
