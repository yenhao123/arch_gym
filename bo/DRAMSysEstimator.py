...
class DRAMSysEstimator_Y(BaseEstimator):

    def __init__(self, cas, cwl, rcd, rp, ras, rrd, faw, rfc, exp_name="test", traject_dir="traj"):
        ...
        self.helper = helpers()
        self.action_dict = {}
        self.action_dict['cas'] = cas
        self.action_dict['cwl'] = cwl
        self.action_dict['rcd'] = rcd
        self.action_dict['rp'] = rp
        self.action_dict['ras'] = ras
        self.action_dict['rrd'] = rrd
        self.action_dict['faw'] = faw
        self.action_dict['rfc'] = rfc
    ...
    def get_params(self, deep=False):
        return {'cas': self.action_dict['cas'],
                'cwl': self.action_dict['cwl'],
                'rcd': self.action_dict['rcd'],
                'rp': self.action_dict['rp'],
                'ras': self.action_dict['ras'],
                'rrd': self.action_dict['rrd'],
                'faw': self.action_dict['faw'],
                'rfc': self.action_dict['rfc'],
               }
      
    def set_params(self, **params):
        _params = params
        self.action_dict['cas'] = _params['cas']
        self.action_dict['cwl'] = _params['cwl']
        self.action_dict['rcd'] = _params['rcd']
        self.action_dict['rp'] = _params['rp']
        self.action_dict['ras'] = _params['ras']
        self.action_dict['rrd'] = _params['rrd']
